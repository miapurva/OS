...
int main()
{
	...
	{
	int y=0;
	y=process_finish[k]-1;
	int variable = arr[y].burst_time ;
	cout<<"|" ;
	for( int p=variable; p>0; p-- )
	{
	cout<<"-";
	}
	cout<<"P"<<process_finish[k]<<"|" ;
	}
	return 0;
	*/
}
...

{
	...
	cout<<"\n\nProcess Finish\t| Turnaround Time | Waiting Time\n\n";
