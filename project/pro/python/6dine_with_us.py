...
def main():
	...
	'''
	food[8]= sphere(pos=(0.2,-0.37,15),radius=0.20,color=color.yellow)
	food[9]= sphere(pos=(0.65,-0.37,15),radius=0.20,color=color.yellow)
	#third layer
	food[10]= sphere(pos=(-0.425,-0.03,15),radius=0.20,color=color.yellow)
	food[11]= sphere(pos=(0	,-0.03,15),radius=0.20,color=color.yellow)
	food[12]= sphere(pos=(0.425,-0.03,15),radius=0.20,color=color.yellow)
	
	#fourth layer
	food[13]= sphere(pos=(-0.2125,0.35,15),radius=0.20,color=color.yellow)
	food[14]= sphere(pos=(0.2125,0.35,15),radius=0.20,color=color.yellow)
	#fifth layer
	food[15]= sphere(pos=(0,0.75,15),radius=0.20,color=color.yellow)
	'''
